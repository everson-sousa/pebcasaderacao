    ...
    return (
        <section className="bg-black text-white relative overflow-hidden">
            <div>
                ...
                <Image
                    src="/pebnovo.jpg" // Caminho direto sem import
                    alt="Logo de fundo"
                    fill
                    sizes="100vw"
                    priority
                ...
                <article className="grid grid-cols-1 lg:grid-cols-2 gap-8 relative">
                    <div className="space-y-6">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex mt-4">
                                <div className="w-32 hidden lg:block">
                                    {/* Imagem do Gato Pequena */}
                                    <Image
                                        src="/cat-hero.png" // Caminho direto
                                        alt="catHero"
                                        width={150} // Definir tamanho é obrigatório aqui
                                        height={150}
                                        quality={100}
                                        className="object-fill"
                                    />
                    ...
                    <div className="hidden md:block h-full relative">
                        {/* Imagem Logo Grande Desktop */}
                        <Image
                            src="/pebnovo.jpg" // Caminho direto
                            alt='Logo'
                            priority
                            className="object-contain"
                            fill
