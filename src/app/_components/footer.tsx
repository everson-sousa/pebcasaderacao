                ...
                <footer className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 mt-5'>
                    ...
                    >
                        ...
                        <div>
                            ...
                            {/*<p>Email:eloa.palopoli@hotmail.com</p>*/}
                              <a
                                href="mailto:pebcasaderacoes2019@gmail.com?subject=Contato%20via%20site"
                                className="text-white text-base hover:underline transition-all"
                            >
                                Email: pebcasaderacoes2019@gmail.com
                            </a>                         
                            <p>telefone:(11)96273-4996</p>
                            <p>Endereço: Estrada Takashi Kobata, 31 Jardim Europa, Suzano SP</p>
